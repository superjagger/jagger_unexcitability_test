require_relative 'lib/jagger_unexcitability_test/version'

Gem::Specification.new do |spec|
  spec.name          = "jagger_unexcitability_test"
  spec.version       = JaggerUnexcitabilityTest::VERSION
  spec.authors       = ["111"]
  spec.email         = ["1336098842@qq.com"]

  spec.summary       = %q{jagger_unexcitability_test} 
  spec.description   = %q{jagger_unexcitability_test test gem push} 
  spec.homepage      = "https://github.com/superjagger/jagger_unexcitability_test" 
  spec.license       = "MIT"
  spec.required_ruby_version = Gem::Requirement.new(">= 2.3.0")

  spec.metadata["allowed_push_host"] = "https://rubygems.org" 

  spec.metadata["homepage_uri"] = "https://github.com/superjagger/jagger_unexcitability_test" 
  spec.metadata["source_code_uri"] = "https://github.com/superjagger/jagger_unexcitability_test.git" 
  spec.metadata["changelog_uri"] =  "https://github.com/superjagger/jagger_unexcitability_test/blob/main/CHANGELOG.md" 
